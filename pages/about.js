        ...
        <div  id='about' className='aboutme'>
            <div className='aboutMeTitle'>
                ...
                <div className='aboutMeBio'>
                    <button className='resume'><a href='/resume.pdf' target='_blank'>Resume</a></button>
                    ...
                    <a href='https://www.linkedin.com/in/zbarovsky/' target='_blank'><svg className='icon' viewBox="0 0 128 128">
                    ...
                    <a href='https://github.com/zbarovsky' target='_blank'><svg className ='icon' viewBox="0 0 128 128">
